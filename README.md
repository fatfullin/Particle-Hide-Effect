...
## Демо
Посмотрите [демо](https://fatfullin.github.io/Particle-Hide-Effect/) эффекта частиц в действии.
Демонстрация включает в себя пример применения эффекта к тексту.
