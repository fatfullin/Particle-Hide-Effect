...
function createParticleEffect(targetElement, options = {}) {
    ...
    const settings = {
        ...
        edgeMarginPixels: options.edgeMarginPixels || 0 // Дополнительный параметр для отрисовки зоны изменения размера
    };
    ...
    debugZone.style.width = '100%';
    debugZone.style.height = '100%';
    ...
    class Particle {
        ...
        update(deltaTime) {
            ...
            if (settings.shrinkEdges) {
                ...
                const edgeMargin = settings.edgeMarginPixels;
